    ...
    return (
        <div className="card">
            <div className="card-body">
                ...
                <Link to={`/updateAPI/${props.post.id}/edit`} className="btn btn-primary btn-sm float-right m-1 border-0" style={{ backgroundColor: '#0000FF5' }}>
                    <FontAwesomeIcon icon={faPencilAlt} />
                </Link>
                <Link to={`/viewAPI/${props.post.id}`} className="btn btn-info btn-sm float-right m-1 border-0" style={{ backgroundColor: '#23aa17' }}>
                    <FontAwesomeIcon icon={faEye} />
                </Link>
            </div>
                ...
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="modal-footer">
                            ...
                            <button type="button" className="btn btn-danger" data-bs-dismiss="modal"  onClick={()=>{deletePost()
