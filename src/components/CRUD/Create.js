            ...
            <div className="container w-50 bg-white rounded mt-5 p-3">
                <div className="row">
                    <div className="col-8 offset-2">
                        <h1 className="text-center" style={{ fontWeight: 'bold', color: '#23aa17' }}>New Medicine</h1>
                        ...
                        <div className="form-group">
                            <label>Expiry:</label>
                            <input type="date" className="form-control" value={expiry_date} onChange={(event) => { setExpiry_date(event.target.value) }} />
                        </div>
                        <div className="form-group">
