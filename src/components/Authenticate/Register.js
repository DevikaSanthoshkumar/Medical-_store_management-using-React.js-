...
function Register() {
    ...
    <div className="customBg">
        ...
        <div className="container w-50 bg-white rounded mt-5 p-3">
            <div className="row">
                <div className="col-8 offset-2">
                    <h1 style={{ fontWeight: 'bold', color: '#23aa17' }}>Sign Up</h1>
        ...
        <p className="text-center text-light">Already a user? <a href="/login" className="text-decoration-none" style={{ fontWeight: 'bold', color: '#ffda9c' }}>Login</a></p>
    </div>
    )
}
