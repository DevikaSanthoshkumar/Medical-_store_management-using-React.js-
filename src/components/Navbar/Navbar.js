    ...
    return (
      <nav className="navbar navbar-expand-lg navbar-light bg-white customNavbar" style={{ maxWidth: '573px', margin: '0 auto', borderRadius: '30px' }}>
        <NavLink to="/" className={'navbar-brand'+(({isActive})=>(isActive?'active':''))}>
          <img src={logo} alt="logo of Drugport" className="img-fluid customNavBrand" style={{ maxHeight: '25px', marginTop: '-6px' }} />
        </NavLink>
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav ">
            <li className="nav-item customNavItem">
              <NavLink to={"/readAPI"} className={ 'nav-link font-weight-bold customNavItem'+(status => status.isActive ? 'active' : '')} style={{ color: '#23aa17' }}>
                  Medicines
              </NavLink>
            </li>
            <li className="nav-item customNavItem">
              <NavLink to={"/createAPI"} className={ 'nav-link font-weight-bold customNavItem'+(status => status.isActive ? 'active' : '')} style={{ color: '#23aa17' }}>
                  Add New Medicine
              </NavLink>
            </li>
            <li className="nav-item customNavItem">
              <NavLink to={"/aboutus"} className={ 'nav-link font-weight-bold customNavItem'+(status => status.isActive ? 'active' : '')} style={{ color: '#23aa17' }}>
                      About us
              </NavLink>
            </li>
          ...
          <ul className="navbar-nav">
            <li className="nav-item dropdown">
              <a className="nav-link dropdown-toggle customNavItem" href="#" role="button" data-toggle="dropdown" aria-expanded="false" style={{ color: '#23aa17' }}>
